...
// This file is deprecated
	const ie = $.ui.ie = Boolean(/msie [\w.]+/.exec( navigator.userAgent.toLowerCase() ))
...
// >>css.theme: ../../themes/base/theme.css
	...
	// To support the enhanced option in jQuery Mobile, we isolate DOM manipulation
		...
		_updateCornerClass ( element, position ) {
		...
		_buildSimpleOptions ( position, key ) {
		...
		_buttonOptions ( position ) {
			return this._buildSimpleOptions( position, 'ui-button' )
		},

		_checkboxradioOptions ( position ) {
			return this._buildSimpleOptions( position, 'ui-checkboxradio-label' )
		},

		_selectmenuOptions ( position ) {
			const direction = this.options.direction === 'vertical'
			return {
		...
		_resolveClassesValues ( classes, instance ) {
			const result = {}
...
// >>css.theme: ../../themes/base/theme.css
	...
	$.widget( 'ui.button', {
		...
		// _getCreateOptions
			...
			this.hasTitle = Boolean(this.element.attr( 'title' ))
		...
		_attachIconSpace ( iconPosition ) {
			this.icon[(/^(?:end|bottom)/).test( iconPosition ) ? 'before' : 'after']( this.iconSpace )
		},

		_attachIcon ( iconPosition ) {
		...
		_setOption ( key, value ) {
			...
			if ( key === 'closeText' ) {
				...
				// Ensure that we always pass a string
					label: $( '<a>' ).text( String(this.options.closeText) ).html()
				} )
			}
...
// >>css.theme: ../../themes/base/theme.css
	...
	// Support mobile enhanced option and make backcompat more sane
		...
		_setOptionDisabled ( value ) {
			...
			this._toggleClass( this.uiSpinner, null, 'ui-state-disabled', Boolean(value) )
...
// >>css.theme: ../../themes/base/theme.css
	...
	$.widget( 'ui.tooltip', {
		...
		_registerCloseHandlers ( event, target ) {
			const events = {
				keyup ( event ) {
...
// Support: jQuery <1.8
		...
		// Once all animations have completed:
				$.when(...allAnimations.get()).done( function () {
...
/** ****************************************************************************/
	...
	( function () {
		...
		$.extend( $.effects, {
			...
			scaledDimensions ( element, percent, direction ) {
				if ( percent === 0 ) {
					return {
						height: 0,
						width: 0,
	...
	// Injects recently queued functions to be first in line (after "inprogress")
			unshift ( element, queueLength, count ) {
				const queue = element.queue()

				if ( queueLength > 1 ) {
					queue.splice(...[1, 0].concat( queue.splice( queueLength, count ) ))
				}
				element.dequeue()
			},
...
// >>demos: http://jqueryui.com/effect/
	...
	// Create element
		let element = $( this ),
			...
			horizFirst = Boolean(options.horizFirst),
